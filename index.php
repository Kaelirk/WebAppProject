...
<body class="bg-image-index">
  <div class="container">
    <section class="index-welcome mt-5 d-flex justify-content-center align-items-center">
      <div class="index-login-bg bg-light bg-opacity-75 d-inline-flex p-3 rounded-3 shadow-lg">
    ...
    <section class="index-login mt-5 d-flex justify-content-center align-items-center">
      <div class="index-login-bg bg-light bg-opacity-75 d-inline-flex p-3 rounded-3 shadow-lg">
