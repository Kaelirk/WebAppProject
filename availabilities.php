...
<section class="availabilities d-flex justify-content-center align-items-center vh-100">
  <div class="availabilities-bg bg-secondary bg-opacity-25 d-inline-flex p-4 rounded-5">
    <div class="wrapper d-flex flex-column justify-content-center align-items-center">
      <div class="availabilites-table">
