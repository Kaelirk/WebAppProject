...
fetch('./api/bookings.api.php')
    ...
    for (let h = startHour; h < endHour; h++) {
        ...
        btn.className = 'slot ' + (name ? 'takenp' : 'free');//Checks if there is a timeslot is already booked and assigns the CSS class slot taken to it. If the time slot is empty, it assign slot free to the button. this is so the button can look/act different based on availability.
